...
gretting("Eduardo")
  ...
  /*
  Async y await facilita la estructura y lectura del codigo asincrono-
  Permite escribir codigo asíncrono de manera similar a cómo se escribiría código
  asincrono.
  ...
  */
  ...
  try {await greetingCH30("Anneth");
  await greetingCH30("Jimena");
